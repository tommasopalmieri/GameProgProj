...
enum EntityType { PLATFORM, PLAYER, ENEMY, BULLET, KEY   };
enum AIType     { WALKER, GUARD, JUMPER            };
enum AIState    { WALKING, IDLE, ATTACKING  };
enum GuardDirection {HORIZONTAL, VERTICAL};
...
public:
    ...
    void jumpingGuard(Entity* player);
    ...
    void shootBullet(ShootDirection direction);
    
    void ai_activate(Entity* player);
    void ai_walk();
    void ai_guard(Entity* player, GuardDirection guardDirection);
