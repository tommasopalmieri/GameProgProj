...
void LevelA::shootBullet(Entity* shootingEntity){
    
    glm::vec3 pos = glm::vec3(-8.0f, 0.0f, 0.0f);
    shootBullet(shootingEntity, pos);

}


void LevelA::shootBullet(Entity* shootingEntity, glm::vec3 dir){
    if (shootingEntity->is_active()){
        ...
        m_state.enemies_v.back()->set_width(0.1f);
        m_state.enemies_v.back()->set_height(0.1f);
        ...
        m_state.enemies_v.back()->set_acceleration(dir);
...
void LevelA::checkEnemyCollision(){
...
void LevelA::initialise()
{
    ...
    m_state.enemies_v[0]->set_position(glm::vec3(5.0f, -4.0f, 0.0f));
    m_state.enemies_v[0]->set_movement(glm::vec3(0.0f));
    m_state.enemies_v[0]->set_speed(0.1f);
    ...
    m_state.enemies_v[2]->set_position(glm::vec3(12.0f, -3.5f, 0.0f));
    m_state.enemies_v[2]->set_movement(glm::vec3(0.0f));
    m_state.enemies_v[2]->set_speed(0.1f);
    m_state.enemies_v[2]->set_acceleration(glm::vec3(0.0f, -9.81f, 0.0f));
    ...
    m_state.enemies_v[3]->set_ai_type(GUARD);
    ...
    m_state.enemies_v[3]->set_position(glm::vec3(16.0f, -6.0f, 0.0f));
    m_state.enemies_v[3]->set_movement(glm::vec3(0.0f));
    m_state.enemies_v[3]->set_speed(0.1f);
    m_state.enemies_v[3]->set_acceleration(glm::vec3(0.0f, -9.81f, 0.0f));
    ...
    m_state.key->set_position(glm::vec3(16.0f, -2.0f, 0.0f));
...
void LevelA::update(float delta_time)
{
    ...
    if (time_acc > (float(random)/float(10)+1.8) ){
        //playerBullet();
        shootBullet(m_state.enemies_v[2], glm::vec3(8.0f, 0.0f, 0.0f));
        shootBullet(m_state.enemies_v[1]);
